...
These are honest estimates for MiniMax Code's current foreground-subagent model. When MiniMax Code adds async subagents (see `docs/RELIABILITY-ROADMAP.md`), parallel investigation costs will drop further.
